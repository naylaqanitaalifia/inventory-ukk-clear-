...
<div class="flex flex-col gap-1.5">
    ...
    @if($message)
        <p class="mt-1.5 text-theme-xs {{ $state === 'error' ? 'text-error-500' : ($state === 'success' ? 'text-success-500' : 'text-gray-500') }}">
            {{ $message }}
        </p>
    @endif
</div>
